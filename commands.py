...
commands = ["/meme <category> - Meme. Current Categories:\nregular (default)\ndank\nrelatable","/joke - Lame ass jokes","/youtube <search term> - Gives a YouTube video","/wiki <search> - Searches wikipedia for stuff","/suggestion <text>- Suggest new features","/about - My Personal Data (Gives you the Zuck feels)"]
comingSoon = ["Image grabber perhaps","Dynamic categories for memes","Whatever my psycho creator decides","Some tech shit maybe"]
